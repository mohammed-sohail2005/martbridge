...
const VegetableRegister = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch('https://powerful-solace-production-4309.up.railway.app/api/vegetable/register', {
                method: 'POST',
            ...
            if (res.ok) {
                localStorage.setItem('vegId', result.vegetable._id);
                await showAlert('Registration Successful!', 'Success');
    ...
    return (
        <Layout>
            <div className="form-container">
                <h2>Vegetable Shop Registration</h2>
                <form onSubmit={handleSubmit}>
                    ...
                    <p className="switch-link" onClick={() => navigate('/vegetable/login')}>
...
export default VegetableRegister;
