...
const VegetableLogin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                // The API returns { vegetable: { _id: '...' } }
                const id = data.vegetable?._id;
                if (id) {
                    localStorage.setItem('vegId', id);
    ...
    return (
        <div className="login-page">
            <div className="card">
                ...
                <div className="subtitle">Vegetable Shop Login</div>
                ...
                <div className="footer-text">
                    New shop? <Link to="/vegetable/register">Register here</Link>
                </div>
