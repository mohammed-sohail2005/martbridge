...
const VegetableSetPrices = () => {
    ...
    const fetchProducts = async () => {
        try {
            const res = await fetch(`http://localhost:5000/api/product/store/${vegId}`);
            const data = await res.json();
            setItems(data);
        } catch (err) {
    ...
    return (
        <Layout>
            <div className="set-prices-header">
                <h1>🥦 Today's Vegetable Prices</h1>
            ...
            <div className="card">
                <form className="form" onSubmit={handleSubmit}>
                    <input 
                        ...
                        placeholder="Item name (Tomato, Onion...)" 
                        required
                    />
                    <input 
                        type="number" 
            ...
            <style jsx="true">{`
                ...
                .back-btn {
                    background: linear-gradient(135deg, var(--primary-color), #18e187);
                    color: white;
                    border: none;
                    border-radius: 30px;
                    padding: 10px 18px;
                    cursor: pointer;
                    font-weight: 700;
                    box-shadow: 0 6px 18px rgba(11, 177, 93, .35);
                }
                ...
                .form button {
                    ...
                    font-weight: 800;
                    cursor: pointer;
                    box-shadow: 0 8px 22px rgba(11, 177, 93, .35);
                }
                ...
                .del-btn {
                    ...
                    cursor: pointer;
                    font-size: 12px;
                    box-shadow: 0 5px 14px rgba(11, 177, 93, .35);
                }
...
export default VegetableSetPrices;
