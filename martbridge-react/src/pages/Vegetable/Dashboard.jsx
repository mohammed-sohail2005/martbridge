    ...
    const handleSendInvite = async () => {
        ...
        try {
            const res = await fetch(`${API_BASE_URL}/api/store/invite-hotel`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({ hotelName: inviteHotelName, hotelPhone: inviteHotelPhone, storeId: vegId, storeType: "vegetable" })
            });
                ...
                <div className="overlay-blur" onClick={() => setShowInvitePopup(false)}>
                    <div className="invite-card" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="input-group">
                            <input 
                                type="text" 
                                value={inviteHotelPhone} 
                                onChange={e => setInviteHotelPhone(e.target.value)} 
                                placeholder=" " 
                                required
                            />
