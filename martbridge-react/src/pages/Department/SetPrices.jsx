...
const DepartmentSetPrices = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const payload = { storeId: deptId, storeName, name, price, unit };
        ...
        <Layout>
            ...
            <div className="card">
                ...
                <div className="table-responsive">
                    <table>
                        <thead><tr><th>Item Name</th><th>Price (₹)</th><th>Unit</th><th>Actions</th></tr></thead>
                        <tbody>
                            {items.map((item) => (
                                <tr key={item._id}>
                                    <td><b>{item.name}</b></td>
            ...
            <style jsx="true">{`
                ...
                @media (max-width: 768px) {
                    .set-prices-header { flex-direction: column; gap: 15px; text-align: center; }
