...
const DepartmentRegister = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                localStorage.setItem('deptId', result.department._id);
                await showAlert('Department Store Registration Successful!', 'Success');
    ...
    return (
        <Layout>
            <div className="form-container">
                <h2>Department Store Registration</h2>
                <form onSubmit={handleSubmit}>
                    ...
                    <p className="switch-link" onClick={() => navigate('/department/login')}>
                        Already registered? Login here
                    </p>
                </form>
            </div>
            {/* Styles are same as VegetableRegister */}
            <style jsx="true">{`
