...
const MeatLogin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                // The API returns { meat: { _id: '...' } }
                const id = data.meat?._id;
                if (id) {
                    localStorage.setItem('meatId', id);
    ...
    return (
        <div className="login-page">
            <div className="card">
                ...
                <div className="subtitle">Meat Shop Login</div>
                ...
                <div className="footer-text">
                    New shop? <Link to="/meat/register">Register here</Link>
                </div>
