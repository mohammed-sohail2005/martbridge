...
const MeatDashboard = () => {
    ...
    const fetchIncomingOrders = async () => {
        ...
        try {
            ...
            const res = await fetch(`http://localhost:5000/api/store/incoming-orders/${meatId}?date=${today}`);
            const data = await res.json();
    ...
    const fetchLinkedHotels = async () => {
        ...
        try {
            const res = await fetch(`http://localhost:5000/api/store/linked-hotels/${meatId}`);
            const data = await res.json();
